...
FACE_PREDICTOR_PATH = os.path.join(CURRENT_PATH, '../../LipNet-master-3', 'common', 'predictors', 'shape_predictor_68_face_landmarks.dat')

PREDICT_GREEDY      = False
PREDICT_BEAM_WIDTH  = 200
PREDICT_DICTIONARY  = os.path.join(CURRENT_PATH, '../../LipNet-master-3', 'common', 'dictionaries', 'grid.txt')
